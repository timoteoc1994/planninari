...
const updateProject = () => {
    router.post(
        route("projects.update", editingProject.value.id),
        projectForm.value,
        {
            onSuccess: () => {
                ...
                >
                    ...
                    >
                        <p class="text-gray-600">
                            No tienes planes aún. ¡Crea tu primer plan!
                        </p>
                    </div>
                        ...
                        >
                            <div>
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <h3
                                        class="text-xl font-bold text-blue-800 truncate"
                                    >
                                        {{ project.name }}
                                    </h3>
                                </div>
                                <p
                                    class="bg-blue-50/60 text-gray-700 text-sm mb-4 line-clamp-3 rounded-lg px-3 py-2 shadow-inner"
                                >
                                    {{
                            ...
                            <div class="flex flex-col gap-2 mt-2 w-full">
                                ...
                                <div class="flex justify-end mt-2">
                                    <span
                                        class="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-xs font-bold shadow"
                                        >Creado:
                                        {{
