    ...
    <AppLayout title="Etapa 8">
        ...
        <div class="py-12">
          ...
          >
            ...
            <Link
              :href="route('index.recetaestandar', { id: props.proyecto_id })"
            >
              <button
              ...
              >
                Llenar
                    ...
                    >
                        <h3
                            class="text-lg font-bold mb-4 text-gray-700 text-center"
                        >
                            Propuesta de valor
                        </h3>
                        <Link
