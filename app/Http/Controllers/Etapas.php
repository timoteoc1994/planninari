...
class Etapas extends Controller
{
    ...
    public function storeOrUpdate(Request $request, $proyecto_id)
    {
        ...
        $data = $request->validate([
            ...
            'telefono_emprendimiento' => 'nullable|string',
            'email_emprendimiento' => 'nullable|email',
    ...
    public function menu($id)
    {
        ...
        return Inertia::render('DefinicionEstrategica/Menu', [
            'proyectoactual' => $proyecto,
        ]);
    }
    public function definicionindex($id)
    {
        $etapa1 = DefinicionEstrategica::where('proyecto_id', $id)->first();
        $proyectoacutal = Project::find($id);
        return Inertia::render('DefinicionEstrategica/Index', [
            'etapa1' => $etapa1,
            'proyecto_id' => $id,
            'proyectoactual' => $proyectoacutal,
        ]);
